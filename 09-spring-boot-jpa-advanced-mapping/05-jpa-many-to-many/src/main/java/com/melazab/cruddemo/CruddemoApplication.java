...
import com.melazab.cruddemo.entity.*;
...
public class CruddemoApplication {
	...
	private void addMoreCoursesForStudent(AppDAO appDAO) {
		...
		Course tempCourse2 = new Course("Information Systems");
	...
	private void createCourseAndStudents(AppDAO appDAO) {
		// create a course
		Course tempCourse = new Course("Theoretical Computer Science ");

		// create the students
		Student tempStudent1 = new Student("Hans","Flick","h.flick@gmail.com");
		Student tempStudent2 = new Student("Lamine","Yamal","ly10@gmail.com");
	...
	private void createCourseAndReviews(AppDAO appDAO) {
		// create a course
		Course tempCourse = new Course("Intro to AI");

		// add some reviews
		tempCourse.addReview(new Review("Great Course...loved it!"));
		tempCourse.addReview(new Review("Thank you!"));
	...
	private void updateCourse(AppDAO appDAO) {
		...
		tempCourse.setTitle("Course of Coaching for Beginners");
	...
	private void updateInstructor(AppDAO appDAO) {
		...
		tempInstructor.setEmail("guradiola@gmail.com");
